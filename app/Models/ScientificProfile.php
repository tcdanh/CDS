...
{
    protected $fillable = [
        'user_id', 'full_name', 'birth_date', 'place_of_birth',
        'gender', 'code_employee', 'unit', 'department', 'position', 'degree',
        'degree_year', 'title', 'title_year', 'contact_office',
        'contact_home', 'phone_office', 'phone_home', 'email_office', 'email_home', 'avatar_path'
    ];
