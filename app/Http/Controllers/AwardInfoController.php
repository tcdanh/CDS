...
class AwardInfoController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $info->load([
            'scientificAwards' => fn ($query) => $query->orderBy('position')->orderBy('id'),
        ]);

        return view('scientific_profiles.awards', [
            'info' => $info,
    ...
    public function edit(Request $request): View
    {
        ...
        return view('scientific_profiles.edit_awards', [
            'info' => $info,
        ]);
    }
}
