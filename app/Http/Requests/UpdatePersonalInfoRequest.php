...
class UpdatePersonalInfoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'redirect_to' => ['nullable', Rule::in(['compensation', 'recognition', 'teaching', 'research', 'awards', 'publications'])],
            'full_name' => ['required_unless:redirect_to,compensation,recognition,teaching,research,awards,publications', 'string', 'max:255'],
            ...
            'teaching_activity_records' => ['nullable', 'array'],
            'teaching_activity_records.*.academic_year' => ['nullable', 'string', 'max:50'],
            'teaching_activity_records.*.undergraduate_hours' => ['nullable', 'integer', 'min:0'],
            'teaching_activity_records.*.graduate_hours' => ['nullable', 'integer', 'min:0'],
            'teaching_activity_records.*.doctoral_hours' => ['nullable', 'integer', 'min:0'],
            'teaching_activity_records.*.notes' => ['nullable', 'string', 'max:1000'],
            'teaching_activity_records.*.position' => ['nullable', 'integer', 'min:0'],
            'supervision_records' => ['nullable', 'array'],
            'supervision_records.*.level' => ['nullable', 'string', 'max:255'],
            'supervision_records.*.student_name' => ['nullable', 'string', 'max:255'],
            'supervision_records.*.topic' => ['nullable', 'string', 'max:500'],
            'supervision_records.*.year' => ['nullable', 'string', 'max:20'],
            'supervision_records.*.notes' => ['nullable', 'string', 'max:1000'],
            'supervision_records.*.position' => ['nullable', 'integer', 'min:0'],
            'research_project_records' => ['nullable', 'array'],
            'research_project_records.*.from_period' => ['nullable', 'string', 'max:50'],
            'research_project_records.*.to_period' => ['nullable', 'string', 'max:50'],
            'research_project_records.*.project_name' => ['nullable', 'string', 'max:500'],
            'research_project_records.*.project_type' => ['nullable', 'string', 'max:255'],
            'research_project_records.*.role' => ['nullable', 'string', 'max:255'],
            'research_project_records.*.budget_million_vnd' => ['nullable', 'integer', 'min:0'],
            'research_project_records.*.status' => ['nullable', 'string', 'max:255'],
            'research_project_records.*.notes' => ['nullable', 'string', 'max:1000'],
            'research_project_records.*.position' => ['nullable', 'integer', 'min:0'],
            'scientific_awards' => ['nullable', 'array'],
            'scientific_awards.*.year' => ['nullable', 'string', 'max:20'],
            'scientific_awards.*.award_name' => ['nullable', 'string', 'max:255'],
            'scientific_awards.*.organization' => ['nullable', 'string', 'max:255'],
            'scientific_awards.*.notes' => ['nullable', 'string', 'max:1000'],
            'scientific_awards.*.position' => ['nullable', 'integer', 'min:0'],
            'scientific_publications' => ['nullable', 'array'],
            'scientific_publications.*.year' => ['nullable', 'string', 'max:20'],
            'scientific_publications.*.title' => ['nullable', 'string', 'max:500'],
            'scientific_publications.*.role' => ['nullable', 'string', 'max:255'],
            'scientific_publications.*.publication_type' => ['nullable', 'string', 'max:255'],
            'scientific_publications.*.publisher' => ['nullable', 'string', 'max:255'],
            'scientific_publications.*.notes' => ['nullable', 'string', 'max:1000'],
            'scientific_publications.*.position' => ['nullable', 'integer', 'min:0'],
            'intellectual_property_records' => ['nullable', 'array'],
            'intellectual_property_records.*.year' => ['nullable', 'string', 'max:20'],
            'intellectual_property_records.*.name' => ['nullable', 'string', 'max:500'],
            'intellectual_property_records.*.ip_type' => ['nullable', 'string', 'max:255'],
            'intellectual_property_records.*.registration_number' => ['nullable', 'string', 'max:255'],
            'intellectual_property_records.*.notes' => ['nullable', 'string', 'max:1000'],
            'intellectual_property_records.*.position' => ['nullable', 'integer', 'min:0'],
        ];
    }
}
