...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Cập nhật thông tin hợp đồng &amp; tài chính</h3></div>
            <div class="col-sm-6">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card card-primary card-outline">
                    ...
                    <form action="{{ route('project-details.update', $project) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
