                ...
                <div class="collapse mt-4" id="updateWeekForm">
                    ...
                    <form method="POST" action="{{ route('work-schedules.update-week') }}" class="row g-3">
                            ...
                            <select name="schedule_id" id="schedule_id" class="form-select @error('schedule_id') is-invalid @enderror" required>
                                ...
                                @foreach ($currentWeekSchedules as $schedule)
                                    @php
                                        ...
                                        $optionDataJson = e(json_encode($optionData, JSON_UNESCAPED_UNICODE));
                                    @endphp
                                    <option value="{{ $schedule->id }}"
                                        data-entry="{{ $optionDataJson }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="time_range" id="time_range" value="{{ old('time_range') }}" class="form-control @error('time_range') is-invalid @enderror">
                            @error('time_range')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="entries[{{ $entryIndex }}][time_range]" id="entry_time_range_{{ $entryIndex }}" data-field="time_range" value="{{ $entry['time_range'] ?? '' }}" class="form-control @error('entries.' . $entryIndex . '.time_range') is-invalid @enderror" >
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="entries[{{ $entryIndex }}][location]" id="entry_location_{{ $entryIndex }}" data-field="location" value="{{ $entry['location'] ?? '' }}" class="form-control @error('entries.' . $entryIndex . '.location') is-invalid @enderror" >
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    if (scheduleSelect) {
                        scheduleSelect.addEventListener('change', function () {
                            ...
                            const data = selected?.dataset?.entry ? JSON.parse(selected.dataset.entry) : null;
